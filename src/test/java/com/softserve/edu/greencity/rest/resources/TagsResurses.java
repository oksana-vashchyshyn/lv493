...
public class TagsResurses extends RestQueries<TagsEntity, ResponseCodeEntity, 
...
//
		addListEntityParameters(RestHttpMethods.GET, new GenericConverter<List<TagsEntity>>() {
		}.getGenericType());
